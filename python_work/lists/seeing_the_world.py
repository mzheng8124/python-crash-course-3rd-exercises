...
# declare list
places = ['germany', 'china', 'japan', 'toyko', 'iceland']
...
# use sorted to output list in reverse alphabetical order
...
# sort for alaphabetical order
places.sort()
print(places)

# sort for reverse alaphabetical order
